...
chrome.webRequest.onBeforeRequest.addListener(function (details) {
        webRequestLog[details.requestId].startTime = Date.now();
        webRequestLog[details.requestId].url = details.url;
        webRequestLog[details.requestId].method = details.method;
...
chrome.webRequest.onCompleted.addListener(function (details) {
        webRequestLog[details.requestId].endTime = Date.now();
    }
)
